...
@section('content')
    <header class="header">
        ...
        <a href="{{ route('about') }}" class="header-logo">ZTF Foundation</a>
    </a>
            </div>
            <nav class="nav-desktop">
                <div class="nav-desktop-links">
                    <a href="{{ route('about') }}" class="nav-link active">Home</a>
    ...
    <section class="bottom-cta-section section-padding">
        ...
        <div class="bottom-cta-buttons">
            <a href="{{ route('home') }}" class="cta-button">Register Now</a>
            <a href="{{ route('home') }}" class="cta-button">Explore Staff Directory</a>
        </div>
    </section>
